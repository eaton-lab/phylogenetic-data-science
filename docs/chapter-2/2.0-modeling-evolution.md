...
histories. This is because your genome, just like everyone elses, is a 
complex *mosaic* of different segments of your ancestors' genomes that 
have been recombined. We will return to the topic of recombination in 
...
and B, labeled (A1, A2, B1, and B2). When this organism form haploid gametes
during reproduction, there is equal probability that a gamete will have
either copy of either gene, such that A1B1 is just as likely as A1B2, A2B1,
or A2B2. This is called the law independent assortment.

Remember Mendel's pea experiments? Well, that's where this idea comes from.
The rule of *independent assortment* was not only an interesting experiment
for understanding overdominance in the phenotypes of wrinkled peas, but 
rather, the fundamental finding of this work was that *genes get passed on to descendants as discrete units independently of one another*. 
This process turns out to be relevant to modeling genealogical relationships
of gene copies, where the genealogy of gene copies at one gene in a genome
can be completely indpendent of the genealogy for gene copies at different
gene in the same diploid organism's genome. The distribution of different
genealogies throughout a single genome, and among populations, is the 
focus on the lessons in this chapter. 
